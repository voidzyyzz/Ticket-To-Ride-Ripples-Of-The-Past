package com.voidzyy.rotp_ttr.client.Particle.custom;
...
import com.github.standobyte.jojo.client.particle.custom.*;
...
public class CustomParticlesHelper {
    ...
    public static void saveSprites(Minecraft mc) {
        ...
        com.voidzyy.rotp_ttr.client.Particle.custom.CustomParticlesHelper.saveSprites(spritesMap, InitParticle.LIGHTWALL.get());
        }
    ...
    public static void createHamonSparkParticles(@Nullable Entity entityToFollow, double x, double y, double z, int particlesCount) {
        ...
        for (int i = 0; i < particlesCount; ++i) {
            ...
            if (entityToFollow == null) {
                ...
                com.github.standobyte.jojo.client.particle.custom.CustomParticlesHelper.addParticle(particle, new Vector3d(x, y, z), particleData.getType().getOverrideLimiter(), false);
            }
        }
    }
